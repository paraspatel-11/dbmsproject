  ...
  <h2>Welcome, <?php echo $_SESSION["fullname"];?>!</h2>
      ...
      <h3>Enter Information</h3>
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="pwd" name="apAge" min="1" max="100" required>
            </div>
            <div class="form-group">
              <label for="pwd">Weight (in kgs):</label>
              <input type="text" class="form-control" id="pwd" name="apweight" size="3" min="1" max="150" required>
            </div>
            <div class="form-group">
              <label for="pwd">Phone No:</label>
              <input type="text" class="form-control" id="pwd" name="apphone_no" maxlength="10" size="10" minlength="10" pattern="\d{10}" required>
            </div>
            <div class="form-group">
              <label for="pwd">Address:</label>
              <textarea class="form-control" id="pwd" name="apaddress" maxlength="100" required></textarea>
            </div>
