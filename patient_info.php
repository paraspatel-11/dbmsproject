...
<?php //  Dentist , Endocrinologist, Dermatologist, Cardiologist, Audiologist, Allergist, Anesthesiologist... 
	?>
<?php
...
/*
<?php
    $result = getPatientsFor('Endocrinologist');
...
?>
<?php
    $result = getPatientsFor('Dermatologist');
...
?>
<?php
    $result = getPatientsFor('Anesthesiologist');
...
?>
<?php
    $result = getPatientsFor('Allergist');
...
?>
<?php
    $result = getPatientsFor('Audiologist');
